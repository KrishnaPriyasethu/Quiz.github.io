...
var QuizService = /** @class */ (function () {
    ...
    QuizService.prototype.getAll = function () {
        return [
            { id: 'data/set1.json', name: 'General Set1' },
            { id: 'data/set2.json', name: 'General Set2' },
            { id: 'data/set3.json', name: 'General Set3' },
            { id: 'data/set4.json', name: 'General Set 4' }
        ];
    };
...
module.exports = __webpack_require__(/*! E:\task\Quizz\Quiz application\ng2-quiz-master\src\main.ts */"./src/main.ts");
